...
//            if ($unite->getId() != $etat->getUnite()->getId()) {
//
//                //Vérifions s'il existe un etats pour cette unité
//                $verif_etat = $em->getRepository('KbhGestionCongesBundle:Etats')->findByUnite($unite);
//                $cp2 = count($verif_etat);
//
////                        var_dump($cp2);
////                        die();
//
//                if ($cp2 == 0) {
//                    //Création d'un nouvelle état
//                    //1-A initialisation des variables
//                    $congesAcquis = 0;
//                    $congesAnterieur = 0;
//                    $totalDroitsAcquis = 0;
...
//                    $new_etat = new Etats();
//
//                    $new_etat->setUnite($unite);
//                    $new_etat->setCongesAcquis($congesAcquis);
//                    $new_etat->setCongesAnterieur($congesAnterieur);
//                    $new_etat->setTotalDroitsAcquis($totalDroitsAcquis);
//                    $new_etat->setTotalCongesConsomme($totalCongesConsomme);
//                    $new_etat->setCongesPris($congesPris);
//                    $new_etat->setPermissions($permissions);
//                    $new_etat->setAbsencesEx($absencesEx);
//                    $new_etat->setStockConge($stockConges);
//                    $new_etat->setTotalAbsences($totalAbsences);
//
//                    $em->persist($new_etat);
//                    $em->flush();
//                }
